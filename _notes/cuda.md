...
Let us understand the following things:
- What elements is the "cuda" entity composed of?

- What is the "cuda" entity made for?
The words they use to define cuda are parallel computing platform, programming model.
